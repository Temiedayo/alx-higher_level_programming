...
class TestRectangle_instantiation(unittest.TestCase):
    """nit tests for testing instantiation of the Rectangle class."""
...
class TestRectangle_stdout(unittest.TestCase):
    ...
    def capture_stdout(rect, method):
        """captures and returns text to be printed to stdout.

        Args:
            rect (Rectangle): Rectangle to print to stdout.
            method (str): method to run on rect.
        Returns:
            Text outputed to stdout by calling method on sq.
        """
        capture = io.StringIO()
        sys.stdout = capture
        if method == "print":
...
class TestRectangle_update_args(unittest.TestCase):
    """unittests for testing update args method of Rectangle class."""
...
class TestRectangle_update_kwargs(unittest.TestCase):
    """unit tests for testing update kwargs method of Rectangle class."""
...
class TestRectangle_to_dictionary(unittest.TestCase):
    """Unit tests for testing to_dictionary method of the Rectangle class."""
