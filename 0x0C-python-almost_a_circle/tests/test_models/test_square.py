...
class TestSquare_area(unittest.TestCase):
    """unittests for testing the area method of Square class."""
...
class TestSquare_stdout(unittest.TestCase):
    ...
    def capture_stdout(sq, method):
        ...
        Args:
            sq (Square): Square to output to stdout.
            method (str): method to be ran on sq.
        Returns:
...
class TestSquare_update_args(unittest.TestCase):
    """unittests for testing update args method of quare class."""
...
class TestSquare_update_kwargs(unittest.TestCase):
    """unittests for testing update kwargs method of quare class."""
